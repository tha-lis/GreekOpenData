...
from datasets import WebServiceParams
import os.path
import csv, Image
...
class GreekOpenData:
    ...
    ### GLOBAL VRIABLES  ###
    language = "GR"
    csvWithDatasets = os.path.join(os.path.dirname(__file__),"data.csv")
    quicklooks_dir =  os.path.join(os.path.dirname(__file__),"quicklooks")
    ...
    def __init__(self, iface):
        ...
        self.updateLanguage()
        #self.init_searchBox()
        #self.dlg.search_lineEdit.installEventFilter(self.dlg)
...
##        if (event.type() == QEvent.MousePress and
##            source is self.dlg.search_lineEdit):
##            pos = event.pos()
##            QMessageBox.information(None, "DEBUG:", str("Hello"))
...
##        self.dlg.search_lineEdit.setFont(font)
    ...
    def search(self):
        ...
        #fille the table with the found datasets
    ...
    def loadWebService(self):
        ...
        #QMessageBox.information(None, "DEBUG:", str(urlWithParams)) 
        #QgsMessageLog.logMessage(urlWithParams)         
